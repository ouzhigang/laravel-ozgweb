...
<head>
	...
	<link href="{{ config('app.url') }}/css/site/index/news_view.css" rel="stylesheet" />
</head>
<body>
	<div id="page_main">
		...
		<div id="page_body">
			<div class="page-body-content">
				<div class="page-body-currnav">当前位置: 首页 &gt; 新闻中心 &gt; {{ $data['name'] }}</div>
	...
	<script src="{{ config('app.url') }}/js/site/index/news_view.js"></script>
