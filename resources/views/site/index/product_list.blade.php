...
<head>
	...
	<link href="{{ config('app.url') }}/css/site/index/product_list.css" rel="stylesheet" />
</head>
<body>
	<div id="page_main">
		...
		<div id="page_body">
			<div class="page-body-content">
				<div class="page-body-currnav">当前位置: 首页 &gt; 产品列表</div>
	...
	<script src="{{ config('app.url') }}/js/site/index/product_list.js"></script>
